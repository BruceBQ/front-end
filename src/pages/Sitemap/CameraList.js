                ...
                <div className="card">
                    <div className="card-body camera-item">
                        <div className="camera-snapshot">
                            <img src={camera.snapshot_image} width="80px" />
                        </div>
                        <div className="camera-info">
                            ...
                            <div className="camera-action">
                                <ul>
                                    <li>
                                        <Link to={`/dashboard/camera/${camera._id}/edit`}><button title="Chi tiết"><FontAwesomeIcon icon={faCog} /></button></Link>
                                    </li>
                                    <li>
                                        <button onClick={this.handleSubcribe} title="Theo dõi"><FontAwesomeIcon icon={faEye}/></button>
                                    </li>
                                </ul>
                            </div>
                        </div>
