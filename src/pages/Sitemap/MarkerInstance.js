...
class MarkerInstance extends Component{
    ...
    render(){
        ...
        return (
            <div className={markerStyles} onMouseEnter={this._onMouseEnter} onMouseLeave={this._onMouseLeave} onClick={this._onClick}>
                {isHover && (
                ...
                {this.props.displayInfoWindow && <InfoWindow detail={this.props.detail} closeInfoWindow={this.props.closeInfoWindow}/>}
            </div> 
        )
    }
}
...
class InfoWindow extends Component{
    ...
    render(){
        return (
            <div className="camera-infowindow" onClick={this.props.onClick} onMouseEnter={this._onMouseEnter} onMouseLeave={this._onMouseLeave} onClick={this._onClick}>
                <div className="close-infowindow">
                    <button onClick={this.closeInfoWindow} title="Đóng" className="btn" style={{padding: '0 5px', width:'100%', height: '100%'}}><FontAwesomeIcon icon={faTimes}/></button>
                </div>
                <div className="card">
