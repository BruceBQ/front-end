...
class VideoPlayer extends Component{
    ...
    render(){
        return(
            <div className="video-player" onMouseEnter={this.showControls} onMouseLeave={this.hideControls}>
                        ...
                        <div className="player-live">
                            <div className="centic-video-container">
                                <div className="centic-video">
                                    <video className="centic-video"
                                        ref={this.saveRef}
                                    >
                                    </video>
                                    {!this.state.isLoading && <div className="real-player__loading-wrapper">
