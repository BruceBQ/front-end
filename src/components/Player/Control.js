...
import { faEyeSlash, faExpand, faPlay, faPause, faCompress } from '@fortawesome/free-solid-svg-icons'

class Control extends Component{
    render(){
        const { showControls } = this.props
        return(
            <div className={showControls ? 'video-controls' : 'video-controls video-controls--hide'}>
                <div className="video-controls__left">
                    ...
                    <div className="video-control__live video-controls__tip-btn">
                        <button className="btn-action live">
                            Live
                        </button>
                        <div className="video-controls__title-tip">
                            Live
